<header x-data="{ open: false }" class="bg-cyan-500 border-b border-gray-100  fixed inset-x-0">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <button @click="open = ! open"  class="inline-flex flex-col items-center justify-center p-2 rounded-md text-white hover:text-gray-500 hover:bg-gray-100 focus:outline-none transition">
    ...
    <div :class="{'block ': open, 'hidden': ! open}" class="hidden sm:hidden bg-black h-screen">
